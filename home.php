...
<head>
    ...
    <style>
        ...
        .topbar { display: flex; justify-content: space-between; align-items: center; background-color: #ff5c5c; padding: 15px 30px; border-radius: 0 0 25px 25px; color: white; }
        .topbar .title { font-size: 22px; font-weight: bold; }
